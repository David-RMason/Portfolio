export const workExperience = [
  ...
  {
    title: "Buying and MasterData Coordinator for Fashion & Accessories",
    company: "Aer Rianta International",
    dates: "06/2023 - 04/2024",
    achievements: [
      "Managed product and vendor data for airports across six countries, utilizing TARGIT and Excel for complex data reporting.",
      "Headed a global re-work of product categorization for the Fashion & Accessories division, demonstrating strong analytical and project management skills.",
    ],
  },
];
...
export const education = [
  ...
  },
  {
    ...
    detail: "Geography, Biology, Physics",
    institution: "King Edward VI Camp Hill School",
    dates: "2009 - 2011",
  },
];
...
export const techStack = [
  {
    category: "Languages",
    items: ["JavaScript (ES6+)", "TypeScript", "HTML5", "CSS3", "PHP", "Sass"],
  },
  {
    category: "Frameworks/Libraries",
    items: ["React", "Next.js (Learning)", "BootStrap"],
  },
  {
